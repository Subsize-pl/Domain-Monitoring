...
from domain_monitoring.auth.utils import render_auth_page
from domain_monitoring.core.utils.log.logger import get_logger

# TODO: minimize hard logic in business level
...
async def register(
    ...
    # TODO: take out excess logic from route. Avoid code duplication
    values = {
